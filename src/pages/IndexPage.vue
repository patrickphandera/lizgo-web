    ...
    <div class="q-px-lg q-mx-auto">
      <div class="row q-col-gutter-xl items-center">
        ...
        <div class="col-12 col-md-6">
          <div class="text-weight-bold text-black q-mb-sm text-h3 lt-md">
            Online Learning Platform for Your Syllabus
          </div>

          <div class="text-weight-bold text-black q-mb-sm text-h2 gt-sm">
            Online Learning Platform for Your Syllabus
          </div>
        ...
        <div class="col-12 col-md-6 flex justify-end gt-sm">
          <div class="rounded-borders">
            <HomeLottie style="width: 100%; width: 500px" />
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      features: [{ title: 'MSCE' }, { title: 'JSCE' }, { title: 'GSCE' }, { title: 'PSLCE' }],
    }
  },
}
</script>
